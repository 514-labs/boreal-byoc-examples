 ...
 *    - SKUs: B-series (Balanced), M-series (Memory Optimized), X-series (Compute Optimized), A-series (Flash Optimized)
 *    - ~$251-$32,000+/mo (with High-Availability)
 *    - Port: 10000 (TLS)
...
export interface RedisArgs {
  ...
  skuName?: string; // Cache: "Basic", "Standard", "Premium" | Managed: "Balanced", "MemoryOptimized", "ComputeOptimized", "FlashOptimized"
  skuFamily?: string; // Cache only: "C" or "P" (ignored for managed)
  capacity?: string | number; // Cache: C:0-6, P:1-5 (number) | Managed: "B5", "B10", "M10", "X3", "A250", etc. (string) OR number for backward compatibility
