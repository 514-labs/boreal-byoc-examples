...
| **High-Traffic Production** | Premium          | 2-4 PUs             | ~$678-$1,356 | Dedicated       |
| **Mission-Critical**        | Premium          | 8-16 PUs            | ~$2,712+     | Dedicated       |
...
Azure Event Hubs offers three tiers, all using the standard Kafka protocol, so your application code doesn't change - only the connection details differ.

| Feature                            | Basic           | Standard               | Premium                 |
| ---------------------------------- | --------------- | ---------------------- | ----------------------- |
| **Best For**                       | Dev, Test, POC  | Production workloads   | Mission-critical        |
| **Throughput Model**               | Shared capacity | Shared capacity        | **Dedicated capacity**  |
| **Capacity Units**                 | 1-20 TUs        | 1-20 TUs               | 1-16 PUs                |
| **Ingress**                        | 1 MB/s per TU   | 1 MB/s per TU          | **Up to 200 MB/s**      |
| **Egress**                         | 2 MB/s per TU   | 2 MB/s per TU          | **Up to 400 MB/s**      |
| **Events/Second**                  | 1,000 per TU    | 1,000 per TU           | **100,000+ per PU**     |
...
| **Partitions**                     | Up to 32        | Up to 32               | **Up to 100**           |
| **Kafka Support**                  | ✅ Yes (1.0+)   | ✅ Yes (1.0+)          | ✅ Yes (1.0+)           |
| **Schema Registry**                | ❌ No           | ❌ No                  | ✅ Yes                  |
| **Geo-Disaster Recovery**          | ❌ No           | ✅ Yes (metadata only) | ✅ Yes (metadata only)  |
| **Customer-Managed Keys**          | ❌ No           | ❌ No                  | ✅ Yes                  |
| **VNet Integration**               | ❌ No           | Limited (IP firewall)  | ✅ Full (Private Links) |
| **Zone Redundancy**                | ❌ No           | ✅ Available           | ✅ Standard             |
| **Capture (to Storage/Data Lake)** | ❌ No           | ✅ Yes                 | ✅ Yes                  |
| **Monthly Cost Range**             | ~$11 - $225     | ~$22 - $450            | ~$678 - $10,848         |
...
| -------------- | ---------------- | ---------- | --------- | -------------- | ------------ | ---------------- |
| Premium 1 PU   | 1                | ~50 MB/s   | 1-90 days | ✅ Yes         | ~$678        | Small prod       |
| Premium 2 PUs  | 2                | ~100 MB/s  | 1-90 days | ✅ Yes         | ~$1,356      | Medium prod      |
| Premium 4 PUs  | 4                | ~200 MB/s  | 1-90 days | ✅ Yes         | ~$2,712      | Large prod       |
| Premium 8 PUs  | 8                | ~400 MB/s  | 1-90 days | ✅ Yes         | ~$5,424      | High-traffic     |
| Premium 16 PUs | 16               | ~800 MB/s  | 1-90 days | ✅ Yes         | ~$10,848     | Mission-critical |

**Base Cost**: $678/month per PU (includes dedicated compute)
...
**Cost**: ~$1,356/month | **Throughput**: ~100 MB/s (dedicated) | **SLA**: 99.99% | **Retention**: 30 days
...
### Example 5: High-Performance Production (~$1,356/mo)
...
### Example 6: Enterprise Production (~$2,712/mo)
...
3. **Upgrade**: Premium 2 PUs (~$1,356/mo, 5x throughput)
4. **Scale**: Add more PUs as needed

### Path 3: Direct to Premium

1. **Start**: Premium 2-4 PUs (~$1,356-$2,712/mo)
...
✅ **Enterprise**: Premium for >20 MB/s, dedicated capacity, or 99.99% SLA  
